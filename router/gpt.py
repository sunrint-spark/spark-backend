...
최종단계에 도달한 후 사용자가 markdown 생성 이라 하면 "status": "markdown"으로 저장하고, 지금까지 했던 모든 대화를 정리하여 "main_title에 단어로 저장하고, 모든 대화 기록을 마크다운 형식으로 트리 구조를 확인 할 수 있도록 "markdown"에 저장하세요.
